(function ($) {
    ...
    $(".contact-btn").click(function () { //User clicks on Submit button
        ...
        if (js_subject == "") {
            $("#subjectLb .error").fadeIn('slow').idle(1000).fadeOut('slow');
            return false;
        }
        if (js_message == "") {
        ...
        var myData = 'postName=' + js_name + '&postEmail=' + js_email + '&postPhone=' + js_phone + '&postSubject=' + js_subject + '&postMessage=' + js_message;
